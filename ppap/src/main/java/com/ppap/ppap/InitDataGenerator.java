...
public class InitDataGenerator implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        //         Device.builder().fcmToken("eygXlBJyQWKNtKZ_y1H_BQ:APA91bE6BSy3ZNcSt8AMQ8iH-CoPphLS2J1--Xj_b90wyJN9thcUF45kxpJ5dcJ76_4VR8LlMcIjyVQdg6_Vxp-b2FU5pgtAw6t70OcQ7eEwHc8pcCAZT_5U0qokKUp1Btrmtt2iQY_k").user(userList.get(0)).build()
